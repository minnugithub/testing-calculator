...
test("string with - numbers separated by comma should result in the sum of the numbers", () => {
  expect(calculator.add("-10,-5,5")).toBe(-10);
});

// test case 6
test("string with float numbers separated by comma should result in the sum of the numbers", () => {
  expect(calculator.add("2,0,4.7")).toBe(6.5);
});
